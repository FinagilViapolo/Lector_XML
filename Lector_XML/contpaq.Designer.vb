...
Partial Public Class contpaq
    ...
    Partial Public Class CuentasDataTable
        ...
        Private columnConceptosConsume1 As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public ReadOnly Property ConceptosConsume1Column() As Global.System.Data.DataColumn
            Get
                Return Me.columnConceptosConsume1
            End Get
        End Property
        ...
        Public Overloads Function AddCuentasRow( _
                    ...
                    ByVal ConceptosConsume1 As String,  _
                    ByVal nCuenta As String) As CuentasRow
            Dim rowCuentasRow As CuentasRow = CType(Me.NewRow,CuentasRow)
            Dim columnValuesArray() As Object = New Object() {Id, RowVersion, Codigo, Nombre, NomIdioma, Tipo, EsBaja, CtaMayor, CtaEfectivo, FechaRegistro, SistOrigen, IdMoneda, DigAgrup, IdSegNeg, SegNegMovtos, Afectable, TimeStamp, IdRubro, Consume, IdAgrupadorSAT, ConceptosConsume, ConceptosConsume1, nCuenta}
        ...
        Friend Sub InitVars()
            ...
            Me.columnConceptosConsume1 = MyBase.Columns("ConceptosConsume1")
        ...
        Private Sub InitClass()
            ...
            Me.columnConceptosConsume1 = New Global.System.Data.DataColumn("ConceptosConsume1", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnConceptosConsume1)
            ...
            Me.columnConceptosConsume1.MaxLength = 1000
    ...
    Partial Public Class CuentasRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Property ConceptosConsume1() As String
            Get
                Try 
                    Return CType(Me(Me.tableCuentas.ConceptosConsume1Column),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'ConceptosConsume1' de la tabla 'Cuentas' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableCuentas.ConceptosConsume1Column) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function IsConceptosConsume1Null() As Boolean
            Return Me.IsNull(Me.tableCuentas.ConceptosConsume1Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetConceptosConsume1Null()
            Me(Me.tableCuentas.ConceptosConsume1Column) = Global.System.Convert.DBNull
        End Sub
...
Namespace contpaqTableAdapters
    ...
    Partial Public Class CuentasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("ConceptosConsume1", "ConceptosConsume1")
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Lector_XML.Settings.Default.csContpaqFinagil
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Id, RowVersion, Codigo, Nombre, NomIdioma, Tipo, EsBaja, CtaMayor, "& _ 
                ...
                "       ConceptosConsume,   ConceptosConsume, Codigo + '  ' + Nombre AS nCuenta"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "FROM            Cuentas"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Codigo NOT LIKE '14%') AND (Codigo NOT LI"& _ 
                "KE '13%') AND (Codigo NOT LIKE '2620%') AND (Codigo NOT LIKE '2614%')"
