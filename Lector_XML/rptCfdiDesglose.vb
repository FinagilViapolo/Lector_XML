...
Public Class rptCfdiDesglose
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Lector_XML.rptCfdiDesglose.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCfdiDesglose
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCfdiDesglose = New rptCfdiDesglose()
        rpt.Site = Me.Site
        Return rpt
    End Function
